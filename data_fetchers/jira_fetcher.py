...
class JiraFetcher:
    ...
    def fetch_all_issues(self, sources: Optional[List[Dict[str, Any]]] = None, max_results: int = 1000) -> List[Dict[str, Any]]:
        """
        Fetch all issues based on either the new sources format or the old configuration.
        ...
        if sources:
            ...
            for source in sources:
                ...
                all_issues.extend(self._fetch_issues_with_jql(jql, max_results))
            return all_issues
        ...
        return self._fetch_issues_with_jql(jql, max_results)
